...
export default function DetailPage() {
  ...
  return (
    <div className="m-5 my-10">
      ...
      <div className="flex justify-end gap-5 m-5 mt-0">
      ...
      <div className="border-b-2 border-grey-1"></div>
      <>
        <Accordion open={openAcc1}>
          <AccordionHeader onClick={handleOpenAcc1} className="text-sm">
            자기소개
          </AccordionHeader>
          <AccordionBody className="text-xs font-black leading-5">
            저는 서울대학교 수학과를 졸업했으며, 10년 이상 입시 학원 및 개인 지도를 해온 경력을
            가지고 있습니다. 초등 및 중학수학을 비롯한 수학의 기초다지기, 고등수학 및 심화학습, 내신
            대비, 수능시험을 준비를 위한 타켓 수업등을 폭넓게 진행하고 있습니다.
          </AccordionBody>
        </Accordion>
        <Accordion open={openAcc2}>
          <AccordionHeader onClick={handleOpenAcc2} className="text-sm">
            수업설명
          </AccordionHeader>
          <AccordionBody className="text-xs font-black leading-5">
            초등학생, 중학생 기초 수업은 내신 진행시 1회 3시간으로 수업하며 9시 이후에는 수업하지
            않습니다. 레벨 테스트는 무료로 진행합니다. 고3의 수능대비반의 경우는 족집게 문제풀이
            과정이 별도로 있으며, 시간당 2만원의 추가비용이 있습니다. (교재제공) 물리 수업은 팀으로
            진행하며, 현재 진행중인 팀에 합류하기 위해서는 별도의 테스트를 진행하여야 합니다. 테스트
            비용이 있으며 수강시에 수강료에 산입하여 정산하여 드립니다.
          </AccordionBody>
        </Accordion>
        <Accordion open={openAcc3}>
          <AccordionHeader onClick={handleOpenAcc3} className="text-sm">
            학력 및 경력
          </AccordionHeader>
          <AccordionBody className="text-xs font-black leading-5">
            서울대학교 수학과를 졸업하였으며, 통계 및 해석학 부분의 석사학위를 받았습니다. 현재는
            박사 과정을 진행하고 있습니다. 엠베스트 중학수학 부분의 강의를 진행하였으며, 공통수학과
            미적분에 대한 보조강의도 진행하였습니다. ‘태풍’ 학원의 대치점과 목동점에서 2년간 고3
            수능 만점반의 강의를 진행했습니다. 이외에도 다수의 개인과외 경험이 있습니다.
          </AccordionBody>
        </Accordion>
      </>
      <>
        <p className="mx-5 mb-5 text-sm">수업 가능 시간</p>
